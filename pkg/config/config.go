...
var (
	...
	// will be generated by Rhoc with redefinition variables in source image template
	ImageConfigName string
	// ClusterConfigName is the name for cluster configuration file (for Terraform) that
	// will be generated by Rhoc with redefinition variables in source cluster template
